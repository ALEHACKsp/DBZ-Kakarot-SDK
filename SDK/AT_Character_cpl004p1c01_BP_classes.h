...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AT_Character_cpl004p1c01_BP.AT_Character_cpl004p1c01_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AT_Character_cpl004p1c01_BP(int EntryPoint);
};
