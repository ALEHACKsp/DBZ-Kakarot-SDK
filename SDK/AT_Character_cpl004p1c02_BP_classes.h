...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AT_Character_cpl004p1c02_BP.AT_Character_cpl004p1c02_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AT_Character_cpl004p1c02_BP(int EntryPoint);
};
