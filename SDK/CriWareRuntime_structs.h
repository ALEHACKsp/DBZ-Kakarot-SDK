...
enum class ESndVoiceLanguage : uint8_t
{
...
struct FAtomProfileItem
{
	...
	struct FVector                                     AtomComponentLocation;                                    // 0x0018(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FIntPoint                                   TextureDimensions;                                        // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FIntPoint                                   DisplayDimensions;                                        // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
