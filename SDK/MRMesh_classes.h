...
public:
	...
	bool                                               bCreateMeshProxySections;                                 // 0x0578(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUpdateNavMeshOnMeshUpdate;                               // 0x0579(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
