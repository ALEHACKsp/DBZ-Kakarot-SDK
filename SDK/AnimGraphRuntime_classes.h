...
{
public:
	TArray<struct FAnimationPlayInSequence>            AnimsInSequencer;                                         // 0x0360(0x0010) (ZeroConstructor)
	struct FAnimationPlayInSequence                    mainAnimation;                                            // 0x0370(0x0010) (BlueprintVisible, BlueprintReadOnly)
