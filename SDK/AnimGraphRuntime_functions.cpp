...
bool UAnimSequencerInstance_AnimBP::IsSequencerPlaying()
{
	static auto fn = UObject::FindObject<UFunction>("Function AnimGraphRuntime.AnimSequencerInstance_AnimBP.IsSequencerPlaying");

	UAnimSequencerInstance_AnimBP_IsSequencerPlaying_Params params;
