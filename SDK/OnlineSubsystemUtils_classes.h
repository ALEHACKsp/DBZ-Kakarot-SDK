...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0338(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0350(0x0010) (ZeroConstructor)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x03E0(0x0010) (ZeroConstructor)
