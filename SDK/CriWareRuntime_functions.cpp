...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TArray<int>                    AsrRackIDs                     (Parm, ZeroConstructor)

void UAtomComponent::SetAsrRackIdArray(TArray<int> AsrRackIDs)
{
	static auto fn = UObject::FindObject<UFunction>("Function CriWareRuntime.AtomComponent.SetAsrRackIdArray");

	UAtomComponent_SetAsrRackIdArray_Params params;
	params.AsrRackIDs = AsrRackIDs;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// EManaMaxFrameDrop              InMaxDropFrames                (Parm, ZeroConstructor, IsPlainOldData)

void UManaComponent::SetMaxDropFrames(EManaMaxFrameDrop InMaxDropFrames)
{
	static auto fn = UObject::FindObject<UFunction>("Function CriWareRuntime.ManaComponent.SetMaxDropFrames");

	UManaComponent_SetMaxDropFrames_Params params;
	params.InMaxDropFrames = InMaxDropFrames;
...
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction CriWareRuntime.ManaComponent.OnMovieChanged__DelegateSignature");

	UManaComponent_OnMovieChanged__DelegateSignature_Params params;
	params.Movie = Movie;
	params.ManaComponent = ManaComponent;
