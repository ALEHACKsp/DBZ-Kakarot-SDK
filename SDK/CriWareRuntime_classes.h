...
{
public:
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0250(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0251(0x0003) MISSED OFFSET
	bool                                               bPersistAcrossLevelTransition;                            // 0x0254(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0255(0x0003) MISSED OFFSET
	unsigned char                                      bStopWhenOwnerDestroyed : 1;                              // 0x0258(0x0001)
	unsigned char                                      bIsUISound : 1;                                           // 0x0258(0x0001)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0259(0x0007) MISSED OFFSET
	float                                              DefaultVolume;                                            // 0x0260(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableMultipleSoundPlayback;                             // 0x0264(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUsePlaylist;                                             // 0x0265(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0266(0x0002) MISSED OFFSET
	class UAtomSoundObject*                            DefaultSoundObject;                                       // 0x0268(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DefaultBlockIndex;                                        // 0x0270(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0274(0x0004) MISSED OFFSET
	TArray<struct FAtomAisacControlParam>              DefaultAisacControl;                                      // 0x0278(0x0010) (Edit, ZeroConstructor)
	TArray<struct FAtomSelectorParam>                  DefaultSelectorLabel;                                     // 0x0288(0x0010) (Edit, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0298(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UWorld*                                      PlayWorld;                                                // 0x02A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGameViewportClient*                         GameViewport;                                             // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x18];                                      // 0x02B8(0x0018) MISSED OFFSET
	unsigned char                                      bOverrideAttenuation : 1;                                 // 0x02D0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData06[0x7];                                       // 0x02D1(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x928];                                     // 0x0588(0x0928) MISSED OFFSET
...
public:
	...
	class UCriFsBinderComponent*                       BinderComponent;                                          // 0x0260(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnLoadCompleted;                                          // 0x0268(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLoadError;                                              // 0x0278(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x30];                                      // 0x0288(0x0030) MISSED OFFSET
	class USoundAtomCueSheet*                          CueSheet;                                                 // 0x02B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UAtomSoundObject*                            SoundObject;                                              // 0x0100(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class USoundAtomCueSheet*                          CueSheet;                                                 // 0x0338(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnBindCompleted;                                          // 0x0258(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnBindError;                                              // 0x0268(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x28];                                      // 0x0278(0x0028) MISSED OFFSET
...
{
public:
	class UCriFsLoaderComponent*                       LoaderComponent;                                          // 0x0338(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnLoadError;                                              // 0x0268(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x48];                                      // 0x0278(0x0048) MISSED OFFSET
...
public:
	...
	struct FSoftObjectPath                             AtomConfig;                                               // 0x00F8(0x0018) (Edit, ZeroConstructor, Config)
...
{
public:
	class UManaTexture*                                Movie;                                                    // 0x0100(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnEventPoint;                                             // 0x0108(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSubtitleChanged;                                        // 0x0118(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnStatusChanged;                                          // 0x0128(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnMovieChanged;                                           // 0x0138(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	bool                                               bLoop;                                                    // 0x01A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01A9(0x0003) MISSED OFFSET
	int                                                AudioTrack;                                               // 0x01AC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SubAudioTrack;                                            // 0x01B0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ExtraAudioTrack;                                          // 0x01B4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSubtitlesEnabled;                                        // 0x01B8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01B9(0x0003) MISSED OFFSET
	int                                                SubtitlesChannel;                                         // 0x01BC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaSubtitlesEncoding                             SubtitlesEncoding;                                        // 0x01C0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaFrameAction                                   EndFrameAction;                                           // 0x01C1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaPlaybackTimer                                 PlaybackTimer;                                            // 0x01C2(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaMaxFrameDrop                                  MaxFrameDrop;                                             // 0x01C3(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8C];                                      // 0x01C4(0x008C) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EPixelFormat>                          Format;                                                   // 0x00B8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	EManaComponentTextureType                          ComponentType;                                            // 0x00B9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	TEnumAsByte<ETextureAddress>                       AddressX;                                                 // 0x00BA(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	TEnumAsByte<ETextureAddress>                       AddressY;                                                 // 0x00BB(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
...
{
public:
	class UManaSource*                                 MovieSource;                                              // 0x00B0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FString                                     MovieFilePath;                                            // 0x00B8(0x0010) (ZeroConstructor, Deprecated)
	unsigned char                                      bRenderToTexture : 1;                                     // 0x00C8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C9(0x0003) MISSED OFFSET
	float                                              TargetGamma;                                              // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bHDR : 1;                                                 // 0x00D0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00D1(0x0003) MISSED OFFSET
	TEnumAsByte<ETextureAddress>                       AddressX;                                                 // 0x00D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextureAddress>                       AddressY;                                                 // 0x00D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x00D6(0x0002) MISSED OFFSET
	struct FLinearColor                                ClearColor;                                               // 0x00D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EPixelFormat>                          OverrideFormat;                                           // 0x00E8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x00E9(0x0007) MISSED OFFSET
	TArray<class UManaComponentTexture*>               ComponentTextures;                                        // 0x00F0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst)
	unsigned char                                      UnknownData04[0x20];                                      // 0x0100(0x0020) MISSED OFFSET
...
{
public:
	struct FExpressionInput                            Luma;                                                     // 0x0040(0x0010)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0050(0x0008) MISSED OFFSET
	struct FExpressionInput                            ChromaB;                                                  // 0x0058(0x0010)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0068(0x0008) MISSED OFFSET
	struct FExpressionInput                            ChromaR;                                                  // 0x0070(0x0010)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0080(0x0008) MISSED OFFSET
	struct FExpressionInput                            Alpha;                                                    // 0x0088(0x0010)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0098(0x0008) MISSED OFFSET
	struct FExpressionInput                            Gamma;                                                    // 0x00A0(0x0010)
	unsigned char                                      UnknownData04[0x8];                                       // 0x00B0(0x0008) MISSED OFFSET
	bool                                               bH264;                                                    // 0x00B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EManaColorSpace                                    ColorSpace;                                               // 0x00B9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseGammaExponent;                                        // 0x00BA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x00BB(0x0001) MISSED OFFSET
	float                                              ConstGamma;                                               // 0x00BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FExpressionInput                            Inputs[0x3];                                              // 0x0040(0x0010)
