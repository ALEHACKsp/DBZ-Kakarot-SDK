...
public:
	...
	bool                                               bRunning;                                                 // 0x0598(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLooping;                                                 // 0x0599(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x059A(0x0002) MISSED OFFSET
	float                                              StartTimeOffset;                                          // 0x059C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x30];                                      // 0x05AC(0x0030) MISSED OFFSET
	float                                              Duration;                                                 // 0x05DC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bManualTick;                                              // 0x05E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xF];                                       // 0x05E1(0x000F) MISSED OFFSET
