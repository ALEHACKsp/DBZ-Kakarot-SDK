...
// BlueprintGeneratedClass EventItemTreasure_BP.EventItemTreasure_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass EventItemTreasure_BP.EventItemTreasure_BP_C");
		return ptr;
	}
