...
public:
	...
	unsigned char                                      bReverseAsBrake : 1;                                      // 0x0190(0x0001) (Edit)
	unsigned char                                      bUseRVOAvoidance : 1;                                     // 0x0190(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bRawHandbrakeInput : 1;                                   // 0x0190(0x0001) (Transient)
	unsigned char                                      bRawGearUpInput : 1;                                      // 0x0190(0x0001) (Transient)
	unsigned char                                      bRawGearDownInput : 1;                                    // 0x0190(0x0001) (Transient)
	...
	TArray<struct FWheelSetup>                         WheelSetups;                                              // 0x01A0(0x0010) (Edit, ZeroConstructor)
	float                                              DragCoefficient;                                          // 0x01B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisWidth;                                             // 0x01B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisHeight;                                            // 0x01B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FVector                                     InertiaTensorScale;                                       // 0x01CC(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x18];                                      // 0x0208(0x0018) MISSED OFFSET
	float                                              RVOAvoidanceRadius;                                       // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOAvoidanceHeight;                                       // 0x0224(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceConsiderationRadius;                             // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOSteeringStep;                                          // 0x022C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOThrottleStep;                                          // 0x0230(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AvoidanceUID;                                             // 0x0234(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0238(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x023C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0240(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceWeight;                                          // 0x0244(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector                                     PendingLaunchVelocity;                                    // 0x0248(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FReplicatedVehicleState                     ReplicatedState;                                          // 0x0254(0x0014) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0268(0x0004) MISSED OFFSET
	float                                              RawSteeringInput;                                         // 0x026C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawThrottleInput;                                         // 0x0270(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawBrakeInput;                                            // 0x0274(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      UnknownData07[0x24];                                      // 0x02B4(0x0024) MISSED OFFSET
	class AController*                                 OverrideController;                                       // 0x02D8(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class USkeletalMeshComponent*                      Mesh;                                                     // 0x0398(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                          // 0x03A0(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
...
public:
	...
	float                                              AckermannAccuracy;                                        // 0x038C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
