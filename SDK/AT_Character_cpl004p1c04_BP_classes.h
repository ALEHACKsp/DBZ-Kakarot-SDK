...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AT_Character_cpl004p1c04_BP.AT_Character_cpl004p1c04_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AT_Character_cpl004p1c04_BP(int EntryPoint);
};
