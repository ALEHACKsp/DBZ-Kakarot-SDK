...
// BlueprintGeneratedClass MineralMiningPointNormal_BP.MineralMiningPointNormal_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MineralMiningPointNormal_BP.MineralMiningPointNormal_BP_C");
		return ptr;
	}
