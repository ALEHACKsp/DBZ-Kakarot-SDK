...
struct FAnimationPlayInSequence
{
	...
	float                                              BlendWeight;                                              // 0x000C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	EAnimAlphaInputType                                AlphaInputType;                                           // 0x0065(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlphaBoolEnabled;                                        // 0x0066(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData03[0x17];                                      // 0x00C1(0x0017) MISSED OFFSET
};
...
{
	bool                                               bActiveValue;                                             // 0x00D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	TArray<int>                                        EnumToPoseIndex;                                          // 0x00D8(0x0010) (ZeroConstructor)
	unsigned char                                      ActiveEnumValue;                                          // 0x00E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	int                                                ActiveChildIndex;                                         // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
